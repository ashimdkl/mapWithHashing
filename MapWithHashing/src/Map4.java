...
public class Map4<K, V> extends MapSecondary<K, V> {
    ...
    public final void add(K key, V value) {
        ...
        int tempInd = mod(key.hashCode(), this.hashTable.length);
        this.hashTable[tempInd].add(key, value);
    }
    ...
    public final Pair<K, V> remove(K key) {
        ...
        Pair<K, V> removedPair = this.hashTable[tempInd].remove(key);
        return removedPair;
    }
    ...
    public final Pair<K, V> removeAny() {
        int tempInd = 0;
        while (tempInd < this.hashTable.length
                && (this.hashTable[tempInd] == null
                        || this.hashTable[tempInd].size() == 0)) {
            tempInd = tempInd + 1;
        }
        ...
        if (tempInd < this.hashTable.length) {
            removedPair = this.hashTable[tempInd].removeAny();
        }
    ...
    public final V value(K key) {
        ...
        V valueHolder = this.hashTable[tempInd].value(key);
        return valueHolder;
    ...
    public final boolean hasKey(K key) {
        ...
        boolean trueOrF = this.hashTable[tempInd].hasKey(key);
